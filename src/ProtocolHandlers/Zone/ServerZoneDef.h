...
namespace PacketStructures::Server::Zone {
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcSync, STRUCT_FIELD(FFXIVIpcSync, clientTimeValue),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcChat, STRUCT_FIELD(FFXIVIpcChat, type),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(PlayerEntry, STRUCT_FIELD(PlayerEntry, CharacterID),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(ClassJobEntry, STRUCT_FIELD(ClassJobEntry, id),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(
		FFXIVIpcGetCommonlistDetailResult,
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcInviteReplyResult,
		...
		STRUCT_FIELD(FFXIVIpcInviteReplyResult,
			InviteCharacterName));
#endif
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcFriendlistRemoveResult,
		STRUCT_FIELD(FFXIVIpcFriendlistRemoveResult,
			RemovedCharacterID),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcSetProfileResult,
		...
		STRUCT_FIELD(FFXIVIpcSetProfileResult,
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetProfileResult,
		...
		STRUCT_FIELD(FFXIVIpcGetProfileResult,
			CurrentSelectClassID),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetSearchCommentResult,
		STRUCT_FIELD(FFXIVIpcGetSearchCommentResult,
			TargetEntityID),
		STRUCT_FIELD(FFXIVIpcGetSearchCommentResult,
			SearchComment));
#endif
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetCharacterNameResult,
		...
		STRUCT_FIELD(FFXIVIpcGetCharacterNameResult,
			CharacterName));
#endif
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcBlacklistRemoveResult,
		STRUCT_FIELD(FFXIVIpcBlacklistRemoveResult,
			RemovedCharacter),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetLinkshellListResult,
		STRUCT_FIELD(FFXIVIpcGetLinkshellListResult,
			LinkshellList));
#endif
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcChatChannelResult,
		...
		STRUCT_FIELD(FFXIVIpcChatChannelResult,
			TargetCharacterID),
	...
	DECLARE_PACKET_FIELDS(ZoneProtoDownLetterBoxAppendItemBase,
		STRUCT_FIELD(ZoneProtoDownLetterBoxAppendItemBase,
			CatalogID),
		STRUCT_FIELD(ZoneProtoDownLetterBoxAppendItemBase,
			Stack));
#endif
	...
	DECLARE_PACKET_FIELDS(ZoneProtoDownLetterMessage,
		STRUCT_FIELD(ZoneProtoDownLetterMessage,
			SenderCharacterID),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetLetterMessageResult,
		STRUCT_FIELD(FFXIVIpcGetLetterMessageResult,
			LetterMessage),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetLetterMessageDetailResult,
		STRUCT_FIELD(FFXIVIpcGetLetterMessageDetailResult,
			SenderCharacterID),
	...
	DECLARE_PACKET_FIELDS(ZoneProtoDownItemSearchData,
		...
		STRUCT_FIELD(ZoneProtoDownItemSearchData,
			OwnerCharacterID),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetItemSearchListResult,
		STRUCT_FIELD(FFXIVIpcGetItemSearchListResult,
			ItemSearchList),
	...
	DECLARE_PACKET_FIELDS(ZoneProtoDownItemHistoryData,
		...
		STRUCT_FIELD(ZoneProtoDownItemHistoryData,
			BuyCharacterName));
#endif
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetItemHistoryResult,
		...
		STRUCT_FIELD(FFXIVIpcGetItemHistoryResult,
			ItemHistoryList));
#endif
	...
	DECLARE_PACKET_FIELDS(ZoneProtoDownCatalogSearchData,
		...
		STRUCT_FIELD(ZoneProtoDownCatalogSearchData,
			RequestItemCount));
#endif
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(IntegrityStatus, STRUCT_FIELD(IntegrityStatus, Slot),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcResting, STRUCT_FIELD(FFXIVIpcResting, Hp),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(
		FFXIVIpcHudParam, STRUCT_FIELD(FFXIVIpcHudParam, ClassJob),
		STRUCT_FIELD(FFXIVIpcHudParam, Lv), STRUCT_FIELD(FFXIVIpcHudParam, OrgLv),
		STRUCT_FIELD(FFXIVIpcHudParam, LvSync), STRUCT_FIELD(FFXIVIpcHudParam, Hp),
		STRUCT_FIELD(FFXIVIpcHudParam, HpMax), STRUCT_FIELD(FFXIVIpcHudParam, Mp),
		STRUCT_FIELD(FFXIVIpcHudParam, MpMax), STRUCT_FIELD(FFXIVIpcHudParam, Tp),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(MountStruct, STRUCT_FIELD(MountStruct, Id),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcPlayerSpawn,
		...
		STRUCT_FIELD(FFXIVIpcPlayerSpawn,
			PermissionInvisibility1),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcActorMove, STRUCT_FIELD(FFXIVIpcActorMove, dir),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcTransfer, STRUCT_FIELD(FFXIVIpcTransfer, dir),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcWarp, STRUCT_FIELD(FFXIVIpcWarp, Dir),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(ZoneProtoDownHater, STRUCT_FIELD(ZoneProtoDownHater, Id),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcHaterList, STRUCT_FIELD(FFXIVIpcHaterList, Count),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(ZoneProtoDownHate, STRUCT_FIELD(ZoneProtoDownHate, Id),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcHateList, STRUCT_FIELD(FFXIVIpcHateList, Count),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcInitZone, STRUCT_FIELD(FFXIVIpcInitZone, ZoneId),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(
		FFXIVIpcPlayerStatus, STRUCT_FIELD(FFXIVIpcPlayerStatus, CharaId),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcBaseParam, STRUCT_FIELD(FFXIVIpcBaseParam, Param),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcCondition, STRUCT_FIELD(FFXIVIpcCondition, flags),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcStatus, STRUCT_FIELD(FFXIVIpcStatus, effect));
#endif
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcEquip, STRUCT_FIELD(FFXIVIpcEquip, MainWeapon),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(
		FFXIVIpcInspect, STRUCT_FIELD(FFXIVIpcInspect, ObjType),
		STRUCT_FIELD(FFXIVIpcInspect, Sex), STRUCT_FIELD(FFXIVIpcInspect, ClassJob),
		STRUCT_FIELD(FFXIVIpcInspect, Lv), STRUCT_FIELD(FFXIVIpcInspect, LvSync),
		STRUCT_FIELD(FFXIVIpcInspect, Title),
		STRUCT_FIELD(FFXIVIpcInspect, GrandCompany),
		STRUCT_FIELD(FFXIVIpcInspect, GrandCompanyRank),
		STRUCT_FIELD(FFXIVIpcInspect, Flag), STRUCT_FIELD(FFXIVIpcInspect, Crest),
		...
		STRUCT_FIELD(FFXIVIpcInspect, Rank), STRUCT_FIELD(FFXIVIpcInspect, Exp),
		STRUCT_FIELD(FFXIVIpcInspect, ItemLv),
		STRUCT_FIELD(FFXIVIpcInspect, Equipment),
		STRUCT_FIELD(FFXIVIpcInspect, Name), STRUCT_FIELD(FFXIVIpcInspect, PSNId),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcName, STRUCT_FIELD(FFXIVIpcName, contentId),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcGilItem, STRUCT_FIELD(FFXIVIpcGilItem, contextId),
	...
	template <int ArgCount> struct FFXIVIpcMapMarkerN {
	...
	template <int ArgCount> struct FFXIVIpcBattleTalkN {
		uint32_t handlerId;
		uint64_t talkerId;
		uint8_t kind;
		uint8_t __padding1;
	...
	template <int ArgCount> struct FFXIVIpcEventLogMessageN {
		uint32_t handlerId;
		uint32_t messageId;
		uint8_t numOfArgs;
		uint8_t __padding1;
	...
	template <int ArgCount> struct FFXIVIpcUpdateEventSceneN {
		uint32_t handlerId;
		uint16_t sceneId;
		uint8_t numOfArgs;
		uint8_t __padding1;
	...
	template <int ArgCount> struct FFXIVIpcPlayEventSceneN {
		uint64_t actorId;
		uint32_t eventId;
		uint16_t scene;
		uint16_t padding;
	...
	template <int ArgCount> struct FFXIVIpcResumeEventSceneN {
		uint32_t handlerId;
		uint16_t sceneId;
		uint8_t resumeId;
		uint8_t numOfArgs;
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcQuest, STRUCT_FIELD(FFXIVIpcQuest, index),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcQuestCompleteList,
		STRUCT_FIELD(FFXIVIpcQuestCompleteList,
			questCompleteMask),
		STRUCT_FIELD(FFXIVIpcQuestCompleteList,
			unknownCompleteMask));
#endif
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcLegacyQuestCompleteList,
		STRUCT_FIELD(FFXIVIpcLegacyQuestCompleteList,
			completeFlagArray));
#endif
	...
	template <int Size> struct FFXIVIpcNoticeN {
		uint32_t handlerId;
		uint8_t noticeId;
		uint8_t numOfArgs;
		uint8_t __padding1;
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(DailyQuest, STRUCT_FIELD(DailyQuest, questId),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(
		FFXIVIpcNotifyFindContentStatus,
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(
		FFXIVIpcFinishContentMatchToClient,
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcConfig, STRUCT_FIELD(FFXIVIpcConfig, flag));
#endif
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcMount, STRUCT_FIELD(FFXIVIpcMount, id));
#endif
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcHouse, STRUCT_FIELD(FFXIVIpcHouse, Block),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcInterior, STRUCT_FIELD(FFXIVIpcInterior, Window),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcHousingObjectTransform,
		...
		STRUCT_FIELD(FFXIVIpcHousingObjectTransform,
			ContainerIndex),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcHousingObjectTransformMulti,
		...
		STRUCT_FIELD(FFXIVIpcHousingObjectTransformMulti,
			LayoutInfos));
#endif
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(
		FFXIVIpcHousingGetPersonalRoomProfileListResult,
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(
		FFXIVIpcHousingGetHouseBuddyStableListResult,
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(
		FFXIVIpcHousingObjectTransformMultiResult,
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcHousingCombinedObjectStatus,
		STRUCT_FIELD(FFXIVIpcHousingCombinedObjectStatus,
			AddressData),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(
		FFXIVIpcCreateObject, STRUCT_FIELD(FFXIVIpcCreateObject, Index),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetFcHeaderResult,
		...
		STRUCT_FIELD(FFXIVIpcGetFcHeaderResult,
			OnlineMemberCount),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetCompanyBoardResult,
		...
		STRUCT_FIELD(FFXIVIpcGetCompanyBoardResult,
			CompanyBoard));
#endif
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FcHierarchy, STRUCT_FIELD(FcHierarchy, AuthorityList),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetFcHierarchyResult,
		STRUCT_FIELD(FFXIVIpcGetFcHierarchyResult,
			MasterCharacterName),
		STRUCT_FIELD(FFXIVIpcGetFcHierarchyResult,
			FcHierarchyList));
#endif
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FcActivityList, STRUCT_FIELD(FcActivityList, ID),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetFcActivityListResult,
		...
		STRUCT_FIELD(FFXIVIpcGetFcActivityListResult,
			ActivityList));
#endif
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetFcHierarchyLiteResult,
		STRUCT_FIELD(FFXIVIpcGetFcHierarchyLiteResult,
			FcHierarchyList));
#endif
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcGetFcActionResult,
		...
		STRUCT_FIELD(FFXIVIpcGetFcActionResult,
			ActiveActionLeftTime),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcPartyRecruitResult,
		STRUCT_FIELD(FFXIVIpcPartyRecruitResult,
			TargetCharacterID),
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcPartyPos, STRUCT_FIELD(FFXIVIpcPartyPos, Index),
	...
	DECLARE_PACKET_FIELDS(FFXIVIpcUpdateAlliance,
		...
		STRUCT_FIELD(FFXIVIpcUpdateAlliance,
			AllianceMemberCount));
#endif
	...
	struct FFXIVIpcGetRetainerListResult {
		uint8_t data[384];
	};

#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcGetRetainerListResult,
		STRUCT_FIELD(FFXIVIpcGetRetainerListResult, data));
#endif

	struct FFXIVIpcMarketRetainerUpdate {
		uint8_t data[56];
	};

#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcMarketRetainerUpdate,
		STRUCT_FIELD(FFXIVIpcMarketRetainerUpdate, data));
#endif
...
#ifdef DECLARE_PACKET_FIELDS
	DECLARE_PACKET_FIELDS(FFXIVIpcGameLog, STRUCT_FIELD(FFXIVIpcGameLog, MessageID),
	...
	struct FFXIVIpcTriadCardResult {
		uint32_t position;
		uint32_t flippedCards;
		uint32_t scorePlayer;

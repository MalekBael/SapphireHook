...
namespace PacketStructures::Server::Lobby {

    struct FFXIVIpcSyncReply {
    ...
    struct FFXIVIpcServiceLoginReply {
        uint32_t requestNumber;
        uint32_t clientTimeValue;
        uint8_t endOfList : 1;
        uint8_t listIndex : 7;
    ...
    struct FFXIVIpcUpdateRetainerSlotsReply {
        uint32_t requestNumber;
        uint32_t clientTimeValue;
        uint16_t optionParam;
        uint16_t padding;
    ...
    struct FFXIVIpcXiCharacterInfo {
        uint32_t requestNumber;
        uint32_t clientTimeValue;
        uint8_t endOfList : 1;
        uint8_t listIndex : 7;
        ...
        uint16_t optionParam;
        uint32_t optionArg;
        XiCharacterInfo characterArray[12];
    };
    ...
    struct FFXIVIpcDistRetainerInfo {
        uint32_t requestNumber;
        uint32_t clientTimeValue;
        uint8_t endOfList : 1;
        uint8_t listIndex : 7;
    ...
    struct FFXIVIpcDebugNullRepl {
        uint32_t dummyArgument;
    };

    struct FFXIVIpcDebugLoginRepl {
        uint32_t requestNumber;

...
//
// Strategy: Hook the game's WorldToScreen function and capture the ViewProjection 
// matrix as it's passed in or computed. This is more reliable than reading from 
// static memory offsets which may not contain valid matrices.
//
...
namespace SapphireHook::DebugVisuals {
    ...
    // Based on IDA analysis (FFXIV 3.35, correctly rebased to 0x140000000):
    //
    ...
    // We'll use a flexible approach - capture whatever matrix data we find
    ...
    bool ViewProjectionHook::ScanForWorldToScreen() {
        ...
        //
        constexpr uintptr_t RVA_W2S_PRIMARY = 0xDAF6E0;     // Best candidate - has 0.5 constant
        constexpr uintptr_t RVA_W2S_BACKUP = 0x1116A0;      // Backup - matrix offsets
        constexpr uintptr_t RVA_W2S_ALT = 0x1113C0;         // Alternative
        ...
        // ==========================================================
        // STRATEGY: Try the primary candidate first (highest score, has 0.5 constant)
        // ==========================================================
